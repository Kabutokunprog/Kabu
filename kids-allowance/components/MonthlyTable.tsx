...
export default function MonthlyTable({ transactions }: { transactions: Transaction[] }) {
    ...
    <div className="rounded-xl2 bg-white p-4 shadow-sm">
      ...
      <div className="space-y-2">
        {months.map(({ key, totals }) => (
          <div key={key} className="flex items-center justify-between border-b border-ink/5 pb-2 last:border-0 last:pb-0">
